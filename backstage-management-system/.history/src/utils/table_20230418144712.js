...
// 删除表格数据的方法
export function delTableList(delApiFunc, getTableListAgain, id, vueComponentInstance) {
...
// 添加或者修改table中的数据
export function addOrEditTableList(addOrEditApiFunc, getTableListAgain, formData, row) {
  try {
