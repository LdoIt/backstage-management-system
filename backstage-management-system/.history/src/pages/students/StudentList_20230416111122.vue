  ...
  <div>
    <template>
      <el-table :data="studentList" stripe style="width: 100%">
        ...
        <el-table-column prop="address" label="地址" align="center" min-width="120px"> </el-table-column>
        <el-table-column prop="phone" label="联系方式" align="center" min-width="120px"> </el-table-column>
        <el-table-column label="操作" width="180"><el-button type="warning">删除</el-button></el-table-column>
      </el-table>
    </template>
  </div>
</template>
