  ...
  <div class="tableCon">
    <template>
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button type="primary" @click="inquireByName">查询</el-button>
        </el-form-item> 
      </el-form>
...
export default {
  ...
  methods: {
    ...
    // 查询数据
    inquireByName() {
      this.studentList = this.studentList.filter(data => {
        !data.name || data.name.includes(this.formInline.name)
        console.log(data.name.includes(this.formInline.name));
      })
