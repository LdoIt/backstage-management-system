...
<template>
  <div>
    <template>
      <el-table :data="studentList" stripe style="width: 100%" border height="600px">
        ...
        <el-table-column label="操作"><el-button type="danger" class="el-icon-delete"></el-button></el-table-column>
      </el-table>
    </template>
    <div class="block">
      <el-pagination
