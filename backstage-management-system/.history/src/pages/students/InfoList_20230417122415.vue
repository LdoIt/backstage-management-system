...
<template>
  <div>
    <el-button type="primary" class="add" @click="showDialog(false, 'add')">新增</el-button>
    ...
    <el-table :data="infoList" stripe style="width: 100%" border height="570">
        ...
        <el-table-column label="操作" align="center">
          ...
          <template slot-scope="scope">
            ...
            <el-button type="danger" class="el-icon-edit" size="mini" ref="editBtn" @click="showDialog(scope.row, 'edit')"></el-button>
          </template>
        </el-table-column>
      </el-table>
  </div>
...
export default {
  ...
  methods: {
    ...
    showDialog(row, type) { // 传一个id用来判断是否是修改操作
