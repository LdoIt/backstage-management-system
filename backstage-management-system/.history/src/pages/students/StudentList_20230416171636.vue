...
<template>
  <div class="tableCon">
    <template>
      ...
      <el-table :data="studentList.slice((currentPage - 1) * currentSize, currentPage * currentSize).filter(data => !search || data.name.includes(search))" stripe style="width: 100%" border height="535">
