...
<template>
  <div class="tableCon">
    <template>
      <el-table :data="studentList.slice((currentPage - 1) * currentSize, currentPage * currentSize)" stripe style="width: 100%" border height="575">
        ...
        <el-table-column label="操作" align="center"><template slot-scope="scope.row">
          <el-button type="danger" class="el-icon-delete" @click="delStudent(scope.row)"></el-button>
